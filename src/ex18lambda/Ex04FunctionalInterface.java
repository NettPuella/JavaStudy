...
추상메서드를 선언한다. 이를 람다식을 만들기 위한 함수형 인터페이스
라고 한다.
함수형: 인터페이스에는 오직 하나의 추상메서도만 선언할 수 있다. 
*/
/*
...
public class Ex04FunctionalInterface {
	...
	아래와 같이 매개변수로 전달받은 후 추상메서드인 studyLambda()
	를 호출할 수 있다. 
	*/
	static void execute(ISchool4 school4, String s) {
		/*
		school4 => main에서 선언한 람다식을 받은 매개변스
		s => 전달된 문자열
		인터페이스에 정의된 추상메서드 : studyLambda(String sty)
		따라서 아래와 같이 호츨할수 있다.
		 */
	...
	public static void main(String[] args) {
		...
		*/
		...
		람다식 자체가 전달되는 것이 아니라 참조값만 전달된다. 참조값을
