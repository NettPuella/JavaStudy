...
/* Java의 규칙: java.lang 패키지 하위의 모든 클래스는 자동으로
 	...
 	수 있고, object에서 제공하는 메서드는 오버라이딩이 가능한다. */
import java.lang.*;
...
public class E03MathClass extends Object {
	...
	*/
	public static void main(String[] args) {
		...
		/* round의 경우 가장 가까운 정수 쪽으로 올림/버림을
		결정한다. x.5 이상이면 올림처리, 미만이면 버림처리한다.
		...
		System.out.println("Max.max:" + Math.max(100, 99));
		System.out.println("Max.main:" + Math.min(100, 99));
