...
정의된 클래스이다.
이와같이 데이터를 저장하기 위한 용도의 클래스를 가르켜 VO(ValueObject)
...
class HightFriend extends Friend{
	//확장한 멤버변수: 별명
	String nickname;
	//생성자 : 부모의 생성자를 먼저 호출한 후 멤버변수 초기화.
	public HightFriend(String name, String phone, String addr, String nickname) {
...
class UnivFriend extends Friend{
	...
	//오버라이딩 1, 2 역시 HightFriend클래스와 동일한 패턴으로 정의됨
	@Override
	public void showAllData() {
