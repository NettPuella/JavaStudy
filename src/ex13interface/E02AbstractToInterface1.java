...
해당 클래스는 추상메서드를 포함하고 있으므로 하위에서 상속받ㄱ게되면
반드시 추상메서드를 오버라이딩 해야한다. */
abstract class PersonalNumberStorageAbs{
	//정보를 저장하는 기능의 추상메서드
	public abstract void addPersonalInfo(String jumin, String name);
...
public class E02AbstractToInterface1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(storage.searchPersonalInfo("001234-0190333"));
