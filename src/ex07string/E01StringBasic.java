...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/*equals()메서드 : Object클래스로부터 상속받은
		메서드로 실제 저장된 문자열을 비교하도록 정의되어 있다. 즉
		...
		주로 방법 2를 통해 사용하는것이 좋다.*/
		String str3 = "자바개발자";
		String str4 = "자바개발자";
		
		//내용이 동일하므로 true가 출력된다.
		System.out.println("eqials()메소드로 문자열 비교:" + 
				str3.equals(str4));
